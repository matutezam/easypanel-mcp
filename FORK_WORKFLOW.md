...
```bash
git remote -v
# origin   https://github.com/matutezam/easypanel-mcp.git (fetch/push)
...
```bash
git remote set-url origin https://github.com/matutezam/easypanel-mcp.git
